        ...
        <AppBar sx={{ boxShadow: 'none' }}  position="static">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                        ...
                        <Box sx={{ width: '176px' }}>
                            <img style={{ width: '100%' }} src={logo} alt='logo of web site' />
                        </Box>
                        <Menu
                            id="menu-appbar"
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' }, flexGrow: 1 }}>
                        ...
                        <Box sx={{ display: 'flex', }}>
                            ...
                            <Button
                                onClick={handleCloseNavMenu}
                                color='primary'
                                sx={{ my: 2, mr: '21px', display: 'block', color: `${theme.palette.secondary.main}`, boxShadow: `1px 2px 3px ${theme.palette.secondary.main}` }}
                                variant='contained'
                            >
                                My Cart
                            </Button>
